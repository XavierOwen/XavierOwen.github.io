---
content_id: gaussian-process-regression-thesis
language: en
...
- research-teaching
title_zh: 高维与结构化域中的高斯过程回归：变分推断与流形主动学习
title_en: 'Gaussian Process Regression in High-Dimensional and Structured Domains:
  Variational Inference and Active Learning on Manifolds'
summary_zh: 博士论文以能量变分推断和流形主动学习回应高维、结构化域中有限数据下的可靠推断与高效选样问题。
summary_en: A dissertation addressing reliable inference and efficient sample selection
  in high-dimensional structured domains through energetic variational inference and
  manifold active learning.
