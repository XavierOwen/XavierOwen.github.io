---
content_id: energetic-variational-gp-regression
language: en
original_language: en
reader_paths:
- research-teaching
title_zh: 用于计算机试验的能量变分高斯过程回归
title_en: Energetic Variational Gaussian Process Regression for Computer Experiments
summary_zh: 以能量变分推断建立计算机试验的高斯过程回归，并结合收缩估计与变量选择进行预测和统计推断。
summary_en: An energetic variational approach to Gaussian process regression for computer
  experiments, with shrinkage estimation, variable selection, prediction, and inference.
